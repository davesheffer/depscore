...
function usage() {
  console.log(
    `\n  ${bold("shouldi")} ${dim("— should i install this?")}\n\n` +
    `  ${cyan("npx shouldi <package>")}   ${dim("audit one package before you add it")}\n` +
    `  ${cyan("npx shouldi")}             ${dim("audit every dependency in ./package.json")}\n\n` +
